...
/**
 * This is the model class for table "et_ophtrlaser_posteriorpo".
 *
...
class Element_OphTrLaser_PosteriorPole extends SplitEventTypeElement
{
	public $service;
	...
	{
		return 'et_ophtrlaser_posteriorpo';
	}
