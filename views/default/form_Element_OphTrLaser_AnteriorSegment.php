...
<div class="sub-element-fields element-eyes row">
	<div class="element-eye right-eye column optional side left<?php if (!$element->hasRight()) {
    ?> inactive<?php 
}?>" data-side="right">
	...
	<div class="element-eye left-eye column optional side right<?php if (!$element->hasLeft()) {
    ?> inactive<?php 
}?>" data-side="left">
		<div class="active-form">
			<a href="#" class="icon-remove-side remove-side">Remove eye</a>
